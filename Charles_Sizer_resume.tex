...
My career has focused on transitioning food products with unique processing challenges from development into production. I have a track record of applying iterative, constructive methods to proof-of-concept processing lines to create automated production systems which are integrated with upper levels of business logic. I have a strong history of troubleshooting enabled by understanding of fluid processes, electrical systems and software. I solve complex problems using proven data driven approaches and building models to evaluate steady-state and transient phenomena.
...
{\bodytext{
Managed the development of a novel dairy product, associated equipment, facility, processing technology, regulatory compliance, and intellectual property.  Worked closely with Sr Management and direct reports to achieve commercialization and R\&D goals.  Led interactions with Federal and State regulators to determine how the product fit into existing regulatory frameworks. Built and documented Quality Systems to exceed compliance requirements.  Managed department budget, hiring and training. 
