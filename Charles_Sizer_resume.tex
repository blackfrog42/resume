...
{\bodytext{
Boombox Beverage is a startup company established, and plant designed, to process and package cold brew coffee. I was hired to bring the plant into quality compliance with low acid canned foods regulations when the company accepted a contract to manufacture a low acid beverage. 
...
\begin{itemize}
\item A member of the Executive team, informed on critical process designs,
\item business policies, and food safety decisions.  
\item Established Food Safety Program for a startup low acid canned food facility. 
\item Developed and implemented a 21CFR117 FSMA HACCP plan.  
\item Worked close with process authority to establish process filings. 
\item Hired and trained Quality Team, highly regarded as a competent and reliable \item department within the company
\item Launched new (how many?) seasonal products for a national brand
\item Driving force behind SQF certification effort 
\end{itemize}
}}}
\headedsection % Employer name which can include a hyperlink and location/URL on the right side of the page
...
{\bodytext{
Worked closely with a cross-disciplinary team to design and build an progressive assembly line. 

\emph{Major responsibilities}
\begin{itemize}
\item creation of schematics/BOM/panel layout
\item assist with electrical panel builds
\item program PLCs, HMIs, robots, camera and other automation devices
...
{2015- Oct 2018} %employment dates
{\bodytext{
Managed the development of a novel dairy product, processing equipment, controls systems, facility, regulatory compliance, and intellectual property. 
...
\item Investigated complex viscosity phenomena of the product
\end{itemize}

\item Led \$1MM facility build-out 
